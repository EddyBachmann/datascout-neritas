...
// POST /api/analyze
// Body: { content: string, url: string, title: string }
// Retorna: { lead: { empresa, setor, score, temperatura, insight, dores, abordagem } }
...
${content}`;
  ...
  try {
    ...
    for await (const message of query({
      ...
      // Captura via campo result (mensagem final de sucesso)
    ...
    // Parse JSON robusto: extrai entre o primeiro { e o último }
    // (ignora blocos de markdown, texto antes/depois do JSON)
    let lead;
    try {
